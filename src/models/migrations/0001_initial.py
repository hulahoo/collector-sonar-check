    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', src.models.abstract.CreationDateTimeField(auto_now_add=True, verbose_name='создано')),
                ('modified', src.models.abstract.ModificationDateTimeField(auto_now=True, verbose_name='изменено')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('weight', models.IntegerField(default=0, validators=[django.core.validators.MaxValueValidator(100), django.core.validators.MinValueValidator(0)], verbose_name='Вес')),
                ...
                ('supplier_confidence', models.IntegerField(default=0, validators=[django.core.validators.MaxValueValidator(100), django.core.validators.MinValueValidator(0)], verbose_name='Достоверность')),
                ...
                ('false_or_positive', models.BooleanField(default=False)),
                ('comment', models.TextField(default=None, null=True)),
                ('is_archived', models.BooleanField(db_index=True, default=False)),
                ('tag', models.ManyToManyField(default=None, related_name='tags', to='models.tag')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('format_of_feed', models.CharField(choices=[('CSV', 'CSV формат'), ('JSON', 'JSON формат'), ('XML', 'XML формат'), ('TXT', 'TXT формат')], default='TXT', max_length=15, verbose_name='Формат фида')),
                ...
                ('confidence', models.IntegerField(default=0, validators=[django.core.validators.MaxValueValidator(100), django.core.validators.MinValueValidator(0)], verbose_name='Достоверность')),
                ...
                ('indicators', models.ManyToManyField(blank=True, related_name='feeds', to='models.indicator', verbose_name='Индикатор')),
                ('parsing_rules', models.ManyToManyField(blank=True, related_name='feed_parsing_rules', to='models.parsingrule', verbose_name='Правила для парсинга')),
